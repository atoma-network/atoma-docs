...
Notice that, in such case the request input data needs not be on-chain data, or either public data and it can be submitted through a frontend UI, a desktop application, a mobile application, etc.However, in order to be executed it requires some additional smart contract permissioned authorization.
