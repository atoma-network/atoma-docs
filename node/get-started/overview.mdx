...
A node is a computer that joins the Atoma Network to help process AI tasks. Think of nodes as workers in a distributed workforce - each one contributes its computing power to run AI models and gets paid for their work.
...
1. **Choose Your Role**: Decide if you want to run a standard Sampling Consensus node or a Confidential Compute node
...
The more reliable your node is, the better reputation you build, leading to more task assignments and better earning potential.
