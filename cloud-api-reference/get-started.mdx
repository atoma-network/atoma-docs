...
All API requests require authentication using a bearer tokenm, you can get your API key from the [Atoma Dashboard](https://cloud.atoma.network/dashboard). Include your API key in the `Authorization` header:
